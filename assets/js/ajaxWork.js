...
function addItems() {
    ...
    // Validation des champs (ajoutez vos propres conditions)
    if (!p_name || !p_desc || !p_price || !category || !file) {
    ...
    .fail(function(xhr, status, error) {
        ...
        alert('Erreur lors de l\'ajout du produit. Veuillez vérifier la console pour plus d\'informations.');
    });
}
